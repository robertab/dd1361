...
Här beräkans utdata utifrån trädet som skickas in.
Trädet är uppbyggt av next och down pekare som branchas
bara när en rep instruktion kommer, dvs en down.
"""
